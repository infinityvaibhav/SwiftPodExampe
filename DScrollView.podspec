...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Vaibhav/DScrollView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vaibhav' => 'uvaibhavb@gamil.com' }
  s.source           = { :git => 'https://github.com/Vaibhav/DScrollView.git', :tag => s.version.to_s }
